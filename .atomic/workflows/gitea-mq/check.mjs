...
const files = [entry, ...["types", "tools", "prompts", "slices", "ledger", "api-schemas", "process", "s1-observations", "vcs", "proposal-edits", "verify-report", "control", "credentials", "installation", "adoption"].map((n) => `.atomic/workflows/gitea-mq/${n}.ts`)];
const options = {
...
if (process.argv.includes("--commands-only") || process.argv.includes("--vars-only")) {
